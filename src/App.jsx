...
import { MobileCardOverlay } from './components/three/NodeDetailCard'
import NodeHint             from './components/ui/NodeHint'
...
export default function App() {
  ...
  return (
    <div style={{ width: '100vw', height: '100vh', background: '#020510', position: 'relative' }}>
      ...
      {/* 3D Canvas — the primary interface */}
      <ErrorBoundary>
        <Canvas
      ...
      {/* Minimal HTML overlays — only hero, contact, nav, progress */}
      {loaded && (
        <>
          <NavBar />
          <HeroOverlay />
